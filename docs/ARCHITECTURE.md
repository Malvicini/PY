...
- **Structure**: PREFIX/CODE/CODE.pdf hierarchy
- **Prefix Logic**: Extracted from code (2-5 characters, letter-based)
- **Access**: Direct filesystem reads with fallback search
...
4. **PDF View**: Code lookup → filesystem search → embed PDF in browser
